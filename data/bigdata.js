...
=================================== */
const TF_DATA = [
  { id: 201, type: 'tf', question: "Spark DataFrames are distributed collections of Row objects that provide a schema and can be optimized by Catalyst.", options: ["A) True", "B) False"], answer: "A" },
  { id: 202, type: 'tf', question: "MapReduce's shuffle phase occurs between the map and reduce stages and is typically the most network-intensive part.", options: ["A) True", "B) False"], answer: "A" },
  { id: 203, type: 'tf', question: "Parquet files store data row-by-row, making them ideal for OLTP workloads.", options: ["A) True", "B) False"], answer: "B" },
  { id: 204, type: 'tf', question: "A Bloom filter can definitively tell you that an element is NOT present (no false negatives).", options: ["A) True", "B) False"], answer: "A" },
  { id: 205, type: 'tf', question: "Increasing HDFS block size can reduce NameNode metadata overhead for the same total data volume.", options: ["A) True", "B) False"], answer: "A" },
  { id: 206, type: 'tf', question: "Kafka guarantees end-to-end exactly-once delivery automatically for all use cases without additional configuration.", options: ["A) True", "B) False"], answer: "B" },
  { id: 207, type: 'tf', question: "In Cassandra, writes are optimized to be extremely fast because they are append-only and use an LSM-tree design.", options: ["A) True", "B) False"], answer: "A" },
  { id: 208, type: 'tf', question: "In Spark Structured Streaming, the same code that expresses a streaming query can often be used for batch queries (micro-batch unification).", options: ["A) True", "B) False"], answer: "A" },
  { id: 209, type: 'tf', question: "A dataset with very many tiny files can hurt Hadoop/Spark performance and lead to NameNode memory pressure.", options: ["A) True", "B) False"], answer: "A" },
  { id: 210, type: 'tf', question: "Vectorized execution processes values in columnar batches to reduce CPU overhead and improve CPU cache locality.", options: ["A) True", "B) False"], answer: "A" },
  { id: 211, type: 'tf', question: "Predicate pushdown can reduce IO by applying filters at the file-read level.", options: ["A) True", "B) False"], answer: "A" },
  { id: 212, type: 'tf', question: "In a Kafka topic with 10 partitions, a single consumer in a consumer group can read from all 10 partitions simultaneously.", options: ["A) True", "B) False"], answer: "A" },
  { id: 213, type: 'tf', question: "The Count-Min Sketch underestimates frequencies but never overestimates.", options: ["A) True", "B) False"], answer: "B" },
  { id: 214, type: 'tf', question: "Data lakes usually store raw and varied data formats; data warehouses store curated, schema-on-write data.", options: ["A) True", "B) False"], answer: "A" },
  { id: 215, type: 'tf', question: "Apache Flink is designed for stateful stream processing with event-time semantics and strong exactly-once guarantees.", options: ["A) True", "B) False"], answer: "A" },
  { id: 216, type: 'tf', question: "In Spark, broadcasting a very large dataset to all executors is good practice regardless of its size.", options: ["A) True", "B) False"], answer: "B" },
  { id: 217, type: 'tf', question: "Locality Sensitive Hashing (LSH) helps approximate nearest neighbor search in high-dimensional datasets.", options: ["A) True", "B) False"], answer: "A" },
  { id: 218, type: 'tf', question: "HBase supports random real-time read/write access to big tables and is not optimized for complex joins.", options: ["A) True", "B) False"], answer: "A" },
  { id: 219, type: 'tf', question: "A partitioned table with millions of partitions (e.g., one partition per second) is typically a good design.", options: ["A) True", "B) False"], answer: "B" },
  { id: 220, type: 'tf', question: "Schema-on-read allows queries to interpret data formats flexibly at query time but can shift logic/validation cost to query time.", options: ["A) True", "B) False"], answer: "A" },
  { id: 221, type: 'tf', question: "The Greenwald-Khanna (GK) algorithm is designed to compute approximate quantiles with deterministic error bounds.", options: ["A) True", "B) False"], answer: "A" },
  { id: 222, type: 'tf', question: "HyperLogLog provides exact distinct counts for cardinality estimation.", options: ["A) True", "B) False"], answer: "B" },
  { id: 223, type: 'tf', question: "Using partition pruning, query planners can avoid scanning irrelevant partitions, improving performance.", options: ["A) True", "B) False"], answer: "A" },
  { id: 224, type: 'tf', question: "Model parallelism splits model parameters across workers, while data parallelism replicates model and splits data.", options: ["A) True", "B) False"], answer: "A" },
  { id: 225, type: 'tf', question: "Using compression for columnar formats usually increases CPU usage but reduces IO and storage.", options: ["A) True", "B) False"], answer: "A" },
  { id: 226, type: 'tf', question: "A DataNode stores block replicas and serves read/write requests for HDFS blocks.", options: ["A) True", "B) False"], answer: "A" },
  { id: 227, type: 'tf', question: "Enabling Spark speculative execution guarantees no duplicate results in all failure modes.", options: ["A) True", "B) False"], answer: "B" },
  { id: 228, type: 'tf', question: "Parquet's column-chunk and page layout allows reading only required columns, reducing IO.", options: ["A) True", "B) False"], answer: "A" },
  { id: 229, type: 'tf', question: "Using more hash functions in a Bloom filter always reduces the false positive rate no matter the array size.", options: ["A) True", "B) False"], answer: "B" },
  { id: 230, type: 'tf', question: "In Kafka, messages within a partition are strictly ordered by offset.", options: ["A) True", "B) False"], answer: "A" },
  { id: 231, type: 'tf', question: "If two sketches are mergeable, you can arbitrarily merge their summaries and still guarantee the same error bounds.", options: ["A) True", "B) False"], answer: "B" },
  { id: 232, type: 'tf', question: "Spark's persist (MEMORY_AND_DISK) will spill partitions to disk when they don't fit in memory.", options: ["A) True", "B) False"], answer: "A" },
  { id: 233, type: 'tf', question: "A distributed job that shuffles less will always run faster than one that shuffles more.", options: ["A) True", "B) False"], answer: "B" },
  { id: 235, type: 'tf', question: "A broadcast join is efficient when the broadcast side fits comfortably into executor memory.", options: ["A) True", "B) False"], answer: "A" },
  { id: 236, type: 'tf', question: "Exactly-once semantics in streaming make all system-wide failures irrelevant without additional coordination.", options: ["A) True", "B) False"], answer: "B" },
  { id: 237, type: 'tf', question: "Schema registry helps manage Avro/Protobuf schemas and enables consumers to safely evolve schemas.", options: ["A) True", "B) False"], answer: "A" },
  { id: 238, type: 'tf', question: "Hash partitioning always yields balanced partitions regardless of key distribution.", options: ["A) True", "B) False"], answer: "B" },
  { id: 240, type: 'tf', question: "Vectorized readers improve CPU efficiency by operating on batches instead of single rows.", options: ["A) True", "B) False"], answer: "A" },
  { id: 241, type: 'tf', question: "Using larger row-groups in Parquet always improves query performance.", options: ["A) True", "B) False"], answer: "B" },
  { id: 242, type: 'tf', question: "Change Data Capture (CDC) combined with stream processing can enable near-real-time ETL/upsert semantics.", options: ["A) True", "B) False"], answer: "A" },
  { id: 243, type: 'tf', question: "Reducing the number of partitions always improves Spark job performance by reducing task startup overhead.", options: ["A) True", "B) False"], answer: "B" },
  { id: 245, type: 'tf', question: "LSM-trees provide good write throughput but can increase read amplification without compaction.", options: ["A) True", "B) False"], answer: "A" },
  { id: 246, type: 'tf', question: "For all distributed ML algorithms, asynchronous updates converge faster than synchronous updates.", options: ["A) True", "B) False"], answer: "B" },
  { id: 247, type: 'tf', question: "Partitioning data by user_id is a reasonable choice if most queries are per-user lookups.", options: ["A) True", "B) False"], answer: "A" },
  { id: 248, type: 'tf', question: "A skyline of analytical engines is always better than choosing a single best-of-breed engine.", options: ["A) True", "B) False"], answer: "B" },
  { id: 250, type: 'tf', question: "Using reduceByKey() instead of groupByKey() in Spark reduces data shuffled by performing local combiners.", options: ["A) True", "B) False"], answer: "A" },
  { id: 251, type: 'tf', question: "To get deterministic results for floating-point aggregates, you must enforce deterministic reduction order or use stable algorithms.", options: ["A) True", "B) False"], answer: "A" },
  { id: 252, type: 'tf', question: "File format choice (Parquet vs ORC) rarely affects predicate pushdown capabilities.", options: ["A) True", "B) False"], answer: "B" },
  { id: 253, type: 'tf', question: "Merely adding more reducers will always eliminate skew-related slowdowns.", options: ["A) True", "B) False"], answer: "B" },
  { id: 254, type: 'tf', question: "Using a schema registry does not prevent incompatible schema changes unless compatibility settings are enforced.", options: ["A) True", "B) False"], answer: "A" },
  { id: 255, type: 'tf', question: "Stateful stream processing requires exactly the same operator semantics whether runtime uses snapshot+replay or write-ahead logs.", options: ["A) True", "B) False"], answer: "B" },
  { id: 256, type: 'tf', question: "Compaction in systems like Hudi/Delta reduces the number of files and may improve read latency.", options: ["A) True", "B) False"], answer: "A" },
  { id: 257, type: 'tf', question: "Using approximate nearest neighbor (ANN) indexing always returns the true nearest neighbor for all queries.", options: ["A) True", "B) False"], answer: "B" },
  { id: 258, type: 'tf', question: "Spark's DAG scheduler breaks jobs into stages separated by shuffle boundaries.", options: ["A) True", "B) False"], answer: "A" },
  { id: 259, type: 'tf', question: "If you design keys by monotonically increasing timestamps, you risk hotspotting on the latest range.", options: ["A) True", "B) False"], answer: "A" },
  { id: 260, type: 'tf', question: "Kafka topics with replication factor >1 protect against broker failures.", options: ["A) True", "B) False"], answer: "A" },
  { id: 261, type: 'tf', question: "Mergeable sketches are universally better than exact data structures because they have no accuracy tradeoffs.", options: ["A) True", "B) False"], answer: "B" },
  { id: 262, type: 'tf', question: "Using compacted topics for changelog tables allows retaining the latest state per key indefinitely.", options: ["A) True", "B) False"], answer: "A" },
  { id: 263, type: 'tf', question: "When checkpointing is only local (not durable), recovery after node loss can still be guaranteed without replay.", options: ["A) True", "B) False"], answer: "B" },
  { id: 264, type: 'tf', question: "Designing data models for analytics often privileges denormalization to avoid expensive joins.", options: ["A) True", "B) False"], answer: "A" },
];
const QUESTIONS = [
  ...MCQ_DATA,
  ...TF_DATA
